...
./auto/configure \
    ...
    --with-ld-opt=" -fuse-ld=lld -pie -m64 -Wl,-O1 -Wl,--gc-sections -Wl,-z,relro -Wl,-z,now -Wl,-z,noexecstack -Wl,--as-needed -Wl,--no-copy-dt-needed-entries \
      -Wl,-z,nodlopen -Wl,-z,pack-relative-relocs -Wl,--sort-common -Wl,-z,defs -Wl, -Wl,-rpath" \
    --with-compat \
    --with-file-aio \
    --with-pcre-jit \
    --with-stream \
